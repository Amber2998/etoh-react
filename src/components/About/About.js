		...
		<div>
			...
			<div className="d-flex flex-wrap justify-content-center">
				<div className="d-flex justify-content-lg-end justify-content-between col-lg-6 m-lg-0 m-1 " style={{padding: '0'}}>
					<div className="mr-4">
						<h2 className={'apple-text'} style={{ textAlign: "right" }}> <img src="Images/redapple.png" alt="apple" height="24px"/>  Wout</h2>
				...
				<div className="d-flex flex-lg-row flex-row-reverse justify-content-between justify-content-lg-start col-lg-6 m-lg-0 m-1" style={{padding: '0'}}>
					...
					<div className="ml-lg-4">
						<h2 className={'apple-text'} style={{ textAlign: "center" }}> <img src="Images/redapple.png" alt="apple" height="24px"/> Dylan</h2>
			...
			<div className="d-flex justify-content-center flex-wrap">
				<div className="d-flex justify-content-lg-end justify-content-between col-lg-6 m-lg-0 m-1" style={{padding: '0'}}>
					<div className="mr-4">
						<h2 className={'apple-text'} style={{ textAlign: "right" }}> <img src="Images/redapple.png" alt="apple" height="24px"/> Amber</h2>
				...
				<div className="d-flex flex-lg-row flex-row-reverse justify-content-between justify-content-lg-start col-lg-6 m-lg-0 m-1" style={{padding: '0'}}>
					...
					<div className="ml-lg-4">
						<h2 className={'apple-text'} style={{ textAlign: "center" }}><img src="Images/redapple.png" alt="apple" height="24px"/>Elvira</h2>
